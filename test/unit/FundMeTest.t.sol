...
contract FundMeTest is Test {
    ...
    function testAddsFunderToArrayOfFunders() public funded { // used modifiers 
    ...
    function testOnlyUserCanWithdraw() public  funded{// the test word should always be in front of function world of test
